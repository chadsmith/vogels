...
utils.omitInternalKeys = function (schema, params) {
  return _.omit(params, schema.hashKey, schema.rangeKey, 'aws:rep:updateregion', 'aws:rep:updatetime', 'aws:rep:deleting');
};
